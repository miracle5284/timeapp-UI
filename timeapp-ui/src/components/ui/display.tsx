            ...
            <div className="flex">
                {value.map((char, index) => (
                    ...
                    >
                        ...
                        {/* Main digit block */}
                        <div key={index} className="overflow-hidden mx-[0.5px] mt-3 bg-[#111] h-24 w-14 sm:h-30 sm:w-20 relative rounded-sm my-[2px]
                            ...
                            <div className="relative flex w-full h-full justify-center text-center items-center">
                                {useFlip
                                    ...
                                    : <div className="text-[3rem] sm:text-[5rem] font-thin leading-none">{char}</div>}
                            </div>
...
export const Colon = () => {
    return (
        <div className="flex flex-col justify-center items-center gap-1 sm:gap-4 w-full sm:w-auto py-1 sm:py-0">
            <div className="bg-[#666] w-2 h-2 sm:w-3 sm:h-3 rounded-full"></div>
            <div className="bg-[#666] w-2 h-2 sm:w-3 sm:h-3 rounded-full"></div>
        </div>
    );
};
